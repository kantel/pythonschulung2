...
![Boring Stuff](images/boringpython.jpg) ![Boring Stuff D](images/boringpythond.jpg)

Wie man Routineaufgaben mit Python erledigen kann, zeigt das anfängertaugliche Buch »[Automate the Boring Stuff with Python](https://amzn.to/2wP4gbZ)« von *Al Sweigart*. Die über 450 Seiten zeigen alles, was man von Python wissen muß, um Dateien zu lesen und zu schreiben, Bilder zu bearbeiten und Excel-Tabellen zu entzaubern. Wer des Englischen nicht so mächtig ist: Unter dem Titel »[Routineaufgaben mit Python automatisieren – Praktische Programmierlösungen für Einsteiger](https://amzn.to/2wP3I6G)« gibt es auch eine deutsche Übersetzung – allerdings ist diese etwas teurer. Alle Python-Bücher von *Al Sweigart* – und das sind nicht wenige – kann man übrigens in der englischen Version auf seiner Seite »[Invent with Python](http://inventwithpython.com/)« für umme online lesen.
